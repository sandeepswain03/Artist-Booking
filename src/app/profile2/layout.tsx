        ...
        <div className="flex flex-col h-full">
          <div className="p-4 overflow-y-auto">
            <nav className="space-y-2">
              <Link href="/profile2" className="flex items-center gap-x-3 py-2 px-3 text-sm text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-none focus:bg-gray-100">
                General
              </Link>
