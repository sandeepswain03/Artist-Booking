        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid sm:grid-cols-12 gap-2 sm:gap-6">
            ...
            <div className="sm:col-span-9">
              <div className="flex items-center gap-5">
                <Image
                  src={formData.avatarUrl || "https://preline.co/assets/img/160x160/img1.jpg"}
                  alt="Profile Avatar"
                  width={64}
                  height={64}
            ...
            <div className="sm:col-span-3">
              <label htmlFor="username" className="inline-block text-sm text-gray-800 mt-2.5">
                Username
              </label>
            </div>
            <div className="sm:col-span-9">
            ...
            <div className="sm:col-span-3">
              <label htmlFor="bio" className="inline-block text-sm text-gray-800 mt-2.5">
                Bio
              </label>
            </div>
            <div className="sm:col-span-9">
            ...
            <div className="sm:col-span-3">
              <label htmlFor="videoLink1" className="inline-block text-sm text-gray-800 mt-2.5">
                Video Link 1
              </label>
            </div>
            <div className="sm:col-span-9">
            ...
            <div className="sm:col-span-3">
              <label htmlFor="videoLink2" className="inline-block text-sm text-gray-800 mt-2.5">
                Video Link 2
              </label>
            </div>
            <div className="sm:col-span-9">
            ...
            <div className="sm:col-span-3">
              <label htmlFor="videoLink3" className="inline-block text-sm text-gray-800 mt-2.5">
                Video Link 3
              </label>
            </div>
            <div className="sm:col-span-9">
          ...
          <div className="mt-5 flex justify-end gap-x-2">
            ...
            <button
              type="submit"
              disabled={loading}
              className="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 transition-all"
            >
